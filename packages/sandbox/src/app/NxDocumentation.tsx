...
export const NxDocumentation = () => {
  const [whatsNextYCoord, setWhatsNextYCoord] = useState<number>(0);
  const scrollViewRef = useRef<null | ScrollView>(null);
  return (
    <>
      <View style={styles.section}>
        <RNText style={[styles.textXL, styles.appTitleText]} testID="heading">
          Welcome Streamline 👋
        </RNText>
      </View>
      <View style={styles.section}>
        ...
        >
          <View style={styles.shadowBox}>
            ...
            <View style={styles.codeBlock}>
              <RNText style={[styles.monospace]}>nx connect-to-nx-cloud</RNText>
            </View>
          </View>
        </TouchableOpacity>
      </View>
      ...
      >
        <View style={styles.shadowBox}>
          ...
          <View style={[styles.codeBlock, styles.marginBottomLg]}>
            <RNText style={[styles.textXS, styles.monospace, styles.comment]}>
              # Generate UI lib
            </RNText>
            <RNText
            ...
            <RNText style={[styles.textXS, styles.monospace]}>nx g \</RNText>
          ...
          <View style={[styles.codeBlock, styles.marginBottomLg]}>
            <RNText style={[styles.textXS, styles.monospace]}>nx graph</RNText>
          </View>
          <View style={styles.listItem}>
            <Svg
              width={24}
...
export default NxDocumentation;
